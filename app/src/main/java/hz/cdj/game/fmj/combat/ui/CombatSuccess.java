...
public class CombatSuccess {
	...
	private class MsgScreen extends BaseScreen {
		...
		public MsgScreen(String msg) {
			this((Global.MAP_PIXEL_HEIGHT - 24) / 2, msg);
		}
		...
		public MsgScreen(int y, String _msg) {
			...
			mX = (Global.SCREEN_WIDTH - mMsg.getWidth()) / 2;
			mY = y;
		}
	...
	private class LevelupScreen extends BaseScreen {
		...
		@Override
		public void draw(Canvas canvas) {
			canvas.drawBitmap(mInfo, (Global.SCREEN_WIDTH - mInfo.getWidth()) / 2, (Global.MAP_PIXEL_HEIGHT - mInfo.getHeight()) / 2, null);
		}
