...
public class ScreenSaveLoadGame extends BaseScreen {
	...
	private File getSaveFile(int index) {
		return GameView.getInstance().getGameContext().getFileStreamPath(mFileNames[index]);
	}
	...
	public void onKeyUp(int key) {
		if (key == Global.KEY_CANCEL) {
			...
			final File file = getSaveFile(mIndex);
